...
const cardData = Array.from({ length: 52 }, (_, index) => ({
  id: index + 1,
  images: [
    imagesArray[index % imagesArray.length], // Rotate images dynamically
    `https://source.unsplash.com/300x400/?heels,${index}`, // Second image from Unsplash
  ],
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-[300px] overflow-hidden">
        ...
        {/* Navigation Icons - Show on Hover */}
        {isHovered && (
          <>
